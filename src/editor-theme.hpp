...
public:
    ...
    bool hasStyle(unsigned short idx)const
    {
        return _styleDef[idx].set();
    }
    const Optional<wxString>& getStyle(unsigned short idx)const
    {
        return _styleDef[idx];
    }
    void setStyle(unsigned short idx, const wxString& style)
    {
        _styleDef[idx] = style;
    }

    bool hasStyleName(unsigned short idx)const
    {
        return _styleName[idx].set();
    }
    const Optional<wxString>& getStyleName(unsigned short idx)const
    {
        return _styleName[idx];
    }
    void setStyleName(unsigned short idx, const wxString& name)
    {
        _styleName[idx] = name;
    }
...
public:
    ...
    wxString getCurrentThemeName()const
    {
        return _theme;
    }
    ...
    std::map<wxString, EditorTheme>& getThemes()
    {
        return _themes;
    }
    std::map<wxString, EditorStyle>& getStyles()
    {
        return _styles;
    }
