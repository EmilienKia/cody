...
public:
    ...
    void setFileFilter(const wxString& fileFilter)
    {
        _fileFilter = fileFilter;
    }

    wxString getDefaultStyle()const
    {
        return _defStyle;
    }
    void setDefaultStyle(const wxString& defStyle)
    {
        _defStyle = defStyle;
    }
    ...
    void setFilePattern(const wxString& filePattern)
    {
        _filePattern = filePattern;
    }

    const wxArrayString& getPatterns()const
    {
        return _patterns;
    }
    void setPatterns(const wxArrayString& patterns)
    {
        _patterns = patterns;
    }
    ...
    {
        return lexerToName(_lexer);
    }
    void setLexerName(const wxString& lexerName)
    {
        setLexer(lexerFromName(lexerName));
    }



    const Optional<wxString>& getStyleDef(size_t n)const
    {
        return _styleDef[n];
    }
    Optional<wxString>& getStyleDef(size_t n)
    {
        return _styleDef[n];
    }

    const StyleDef& getAppliedStyle(size_t n)const
    {
        return _appliedStyle[n];
    }
    StyleDef& getAppliedStyle(size_t n)
    {
        return _appliedStyle[n];
    }

    const Optional<wxString>& getKeywords(size_t n)const
    {
        return _keywords[n];
    }
    Optional<wxString>& getKeywords(size_t n)
    {
        return _keywords[n];
    }
