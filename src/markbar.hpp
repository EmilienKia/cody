...
public:
    ...
    {
        return GetWindowStyle() & (MB_VERTICAL|MB_HORIZONTAL);
    }
    ...
    void HideCategory(int category)
    {
        ShowCategory(category, false);
    }
    bool IsCategoryShown(int category)const
    {
        return category>=0&&category<=(sizeof(int)*8)?InternalIsCategoryShown(category):false;
    }
...
public:
    ...
    {
        return new wxMarkBarEvent(*this);
    }
